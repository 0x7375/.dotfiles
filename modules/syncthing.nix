# allow specifying a file for gui password: https://github.com/NixOS/nixpkgs/pull/290485
{
  config,
  lib,
  options,
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    assertions = [
      ...
      {
        assertion = !((hasAttr "password" cfg.settings.gui) && (cfg.guiPasswordFile != null));
        message = ''
