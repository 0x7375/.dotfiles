...

{
  ...
  config = lib.mkIf config.me.btrfs.enable {
    ...
    environment.shellAliases.btdu = "sudo mkdir /mnt/crypted; sudo mount -o subvol=/ /dev/mapper/crypted /mnt/crypted && sudo ${pkgs.btdu}/bin/btdu /mnt/crypted && sudo umount -l /mnt/crypted";
