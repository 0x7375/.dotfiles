...
lib.mkIf config.me.gui.enable {
  ...
  hj.xdg.config.files."zathura/zathurarc-dark".text = rc + theme true;
  hj.xdg.config.files."zathura/zathurarc-light".text = rc + theme false;

  hj.xdg.config.files."zathura/zathurarc" = {
    type = "copy";
    permissions = "0644";
    clobber = true;
    text = (rc + theme true);
